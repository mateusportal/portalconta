...
class Empresa(models.Model):
	...
	endereco_rua = models.CharField(max_lenght=250, blank=False, null=False)
	endereco_numero = models.CharField(max_lenght=250, blank=False, null=False)
	endereco_complemento = models.CharField(max_lenght=250, blank=True, null=True)
	endereco_bairro = models.CharField(max_lenght=250, blank=False, null=False)
	endereco_cidade = models.CharField(max_lenght=250, blank=False, null=False)
	endereco_estado = models.CharField(max_lenght=250, blank=False, null=False)
	endereco_pais = models.CharField(max_lenght=250, blank=False, null=False)
	endereco_cep = models.CharField(max_lenght=250, blank=False, null=False)
	telefone_contato = models.CharField(max_lenght=50, blank=False, null=False)
	...
	email_financeiro = models.CharField(max_lenght=150, blank=False, null=False)
