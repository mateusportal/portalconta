...
class Caixa(models.Model):
    ...
    data_vencimento = models.DateField(auto_now=False, auto_now_add=False, null=True)
    data_pagamento = models.DateField(auto_now=False, auto_now_add=False, null=True)
    ...
    tags = models.CharField(max_length=250, blank=True, null=True)
    data_boleto = models.DateField(auto_now=False, auto_now_add=False, null=True)
