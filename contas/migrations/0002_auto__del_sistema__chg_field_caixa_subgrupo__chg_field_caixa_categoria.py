...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caixa.subgrupo'
        db.alter_column(u'contas_caixa', 'subgrupo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Sistema']))

        # Changing field 'Caixa.categoria'
        db.alter_column(u'contas_caixa', 'categoria_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Sistema']))

        # Changing field 'Caixa.grupo_id'
        db.alter_column(u'contas_caixa', 'grupo_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Sistema']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Caixa.subgrupo'
        db.alter_column(u'contas_caixa', 'subgrupo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contas.Sistema']))

        # Changing field 'Caixa.categoria'
        db.alter_column(u'contas_caixa', 'categoria_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contas.Sistema']))

        # Changing field 'Caixa.grupo_id'
        db.alter_column(u'contas_caixa', 'grupo_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contas.Sistema']))
    ...
    models = {
        ...
        u'contas.caixa': {
            ...
            'grupo_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'caixa_grupo_id'", 'to': u"orm['empresas.Sistema']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
