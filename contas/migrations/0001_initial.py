...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contas_cheque', (
            ...
            ('data_recebido', self.gf('django.db.models.fields.DateField')()),
            ('data_compensar', self.gf('django.db.models.fields.DateField')()),
            ('data_compensado', self.gf('django.db.models.fields.DateField')()),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('empresa', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cheque_empresa_id', to=orm['empresas.Empresa'])),
        ...
        db.create_table(u'contas_caixa', (
            ...
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('data_boleto', self.gf('django.db.models.fields.DateField')()),
            ('processo', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(related_name='caixa_categoria_id', to=orm['empresas.Sistema'])),
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='caixa_grupo_id', to=orm['empresas.Sistema'])),
            ('subgrupo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='caixa_subgrupo_id', to=orm['empresas.Sistema'])),
    ...
    models = {
        ...
        u'contas.cheque': {
            ...
            'empresa': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cheque_empresa_id'", 'to': u"orm['empresas.Empresa']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
