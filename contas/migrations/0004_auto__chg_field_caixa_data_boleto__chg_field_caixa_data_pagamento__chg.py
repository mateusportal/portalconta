...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caixa.data_boleto'
        db.alter_column(u'contas_caixa', 'data_boleto', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Caixa.data_pagamento'
        db.alter_column(u'contas_caixa', 'data_pagamento', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Caixa.data_vencimento'
        db.alter_column(u'contas_caixa', 'data_vencimento', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Cheque.data_compensar'
        db.alter_column(u'contas_cheque', 'data_compensar', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Cheque.data_compensado'
        db.alter_column(u'contas_cheque', 'data_compensado', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Cheque.data_recebido'
        db.alter_column(u'contas_cheque', 'data_recebido', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Caixa.data_boleto'
        db.alter_column(u'contas_caixa', 'data_boleto', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Caixa.data_pagamento'
        db.alter_column(u'contas_caixa', 'data_pagamento', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Caixa.data_vencimento'
        db.alter_column(u'contas_caixa', 'data_vencimento', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Cheque.data_compensar'
        db.alter_column(u'contas_cheque', 'data_compensar', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Cheque.data_compensado'
        db.alter_column(u'contas_cheque', 'data_compensado', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Cheque.data_recebido'
        db.alter_column(u'contas_cheque', 'data_recebido', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'contas.caixa': {
            ...
            'data_boleto': ('django.db.models.fields.DateField', [], {}),
        ...
        u'contas.cheque': {
            ...
            'data_compensado': ('django.db.models.fields.DateField', [], {}),
            'data_compensar': ('django.db.models.fields.DateField', [], {}),
            'data_recebido': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
